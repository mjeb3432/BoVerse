        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-1.5 lg:space-y-2 text-[11px] lg:text-xs font-mono">
              ...
              <li><Link href="/factory" className="text-white/70 hover:text-white focus-visible:text-white focus-visible:outline-none focus-visible:underline underline-offset-4 transition-colors">Build Workflow</Link></li>
            </ul>
          </div>
